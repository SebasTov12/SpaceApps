...
<meta name="csrf-token" content="qB1j2_VvwFyRDqZh2nTve9MnivTjrPJVIlDp12jjBCbFcOtaVcrRl_ouu66pOPnDFm_8S6NENh-sxIXRwrw7qw" />
  ...
  <form id="login" action="/login" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="W6IgHSkXPJUZ5U_ACM0A3scWGIk4oD7sN-gAICU7XY02z6icibItXnLFUg97gRZmAl5uNnhI-qa5fGwmj2RiAA" autocomplete="off" />
  <p>
  ...
  <p>
    <input type="hidden" name="client_id" id="client_id" value="iQGRa5KtDl_e-fgYqB5x5Q" autocomplete="off" />
  </p>
  <p>
    <input type="hidden" name="redirect_uri" id="redirect_uri" value="https://asdc.larc.nasa.gov/data/urs" autocomplete="off" />
  </p>
        <p><input type="hidden" name="response_type" id="response_type" value="code" autocomplete="off" /></p>
      <p><input type="hidden" name="state" id="state" value="aHR0cDovL2FzZGMubGFyYy5uYXNhLmdvdi9kYXRhL1RFTVBPL1RFTVBPX0wyX05PMi4wMDEvMjAyNS8yNzUvVEVNUE9fTDJfTk8yXzIwMjUxMDAyVDE1MDBaXzAwMS5uYw" autocomplete="off" /></p>
...
<aside class="govt-msg">
  ...
  <p>
    ...
    <div class="idfs-button-alignment">
          ...
          <a class="eui-btn--round eui-btn--blue" href="/users/new?client_id=iQGRa5KtDl_e-fgYqB5x5Q&amp;redirect_uri=https%3A%2F%2Fasdc.larc.nasa.gov%2Fdata%2Furs&amp;response_type=code&amp;state=aHR0cDovL2FzZGMubGFyYy5uYXNhLmdvdi9kYXRhL1RFTVBPL1RFTVBPX0wyX05PMi4wMDEvMjAyNS8yNzUvVEVNUE9fTDJfTk8yXzIwMjUxMDAyVDE1MDBaXzAwMS5uYw">Register for a Profile</a>
    <div>
</aside>
...
<script id="f5_cspm">(function(){var f5_cspm={f5_p:'EKBFHOCAJAKNJGLNNNJJCHEBCBFPDMGICDMKDJNGAFOAPIMAFCMGNABMKGKJLDBLJHPBMGEJAAAKJFIGHHEAMHHPAAJEMBEGDNADMCPPNDCNABPEHOJALBAGMIFKFAOI',setCharAt:function(str,index,chr){if(index>str.length-1)return str;return str.substr(0,index)+chr+str.substr(index+1);},get_byte:function(str,i){var s=(i/16)|0;i=(i&15);s=s*32;return((str.charCodeAt(i+16+s)-65)<<4)|(str.charCodeAt(i+s)-65);},set_byte:function(str,i,b){var s=(i/16)|0;i=(i&15);s=s*32;str=f5_cspm.setCharAt(str,(i+16+s),String.fromCharCode((b>>4)+65));str=f5_cspm.setCharAt(str,(i+s),String.fromCharCode((b&15)+65));return str;},set_latency:function(str,latency){latency=latency&0xffff;str=f5_cspm.set_byte(str,40,(latency>>8));str=f5_cspm.set_byte(str,41,(latency&0xff));str=f5_cspm.set_byte(str,35,2);return str;},wait_perf_data:function(){try{var wp=window.performance.timing;if(wp.loadEventEnd>0){var res=wp.loadEventEnd-wp.navigationStart;if(res<60001){var cookie_val=f5_cspm.set_latency(f5_cspm.f5_p,res);window.document.cookie='f5avr1300495240aaaaaaaaaaaaaaaa_cspm_='+encodeURIComponent(cookie_val)+';path=/;'+'';}
return;}}
catch(err){return;}
